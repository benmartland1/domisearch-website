...
const ENGINE_SPEC = [
  ...
  },
  {
    area: "Content",
    detail:
      "A monthly programme of pieces written to be quoted rather than ranked: salary data, hiring guides and market commentary.",
  },
  {
    area: "Citations",
    detail:
      "Third-party actions every month: directory listings, listicle inclusion and press placements pitched on your behalf, because AI answers cite sources, not you.",
  },
  {
    area: "Reviews",
    detail:
...
The programme pays for itself if it wins you a single extra client a
          ...
          <div className="mt-5 flex items-start gap-4 rounded-[1.5rem] border border-white/12 bg-white/[0.04] p-5 sm:mt-6 sm:p-8">
            ...
            <div>
              ...
              <p className="mt-2 text-[14px] leading-relaxed text-[color:var(--color-paper)]/60">
                ...
                sub-sector and region, for as long as you are with us. Winning
          ...
          <p className="mt-10 sm:mt-16 text-[13px] text-[color:var(--color-paper)]/45">
            ...
            means one firm per sub-sector, per region. AI visibility compounds, so we do not take clients for
